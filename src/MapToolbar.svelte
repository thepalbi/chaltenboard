...
<button type="button" on:click={() => dispatch('add-marker')} title="Add new marker">
	<Icon
		name="plus-circle"
		size="2em"
	/>
...
<button type="button" on:click={() => dispatch('update-default-loc')} title="Update default location">
	<Icon
		name="map"
		size="2em"
	/>
